    ...
    public partial class ClientForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                using (SqlConnection connExpDtls = new SqlConnection(ConfigurationManager.ConnectionStrings["Game_Rental.Properties.Settings.Game_RentalConnectionString"].ConnectionString))
                {
                    using (SqlCommand cmdExpDtls = new SqlCommand())
                    {
                        try
                        {
                            ...
                            cmdExpDtls.CommandText = cmdExpDtls.CommandText + " Insert Into Client  (Gender,Fname,Lname,phone,Age,NumberOfRenteredGames,email,GID,password) Values (@Gender,@Fname,@Lname,@phone,@Age,@NumberOfRenteredGames,@email,@GID,@password) ";
            ...
            finally
            {
                ...
                ClientOptions f = new ClientOptions();
                f.Show();
            }
